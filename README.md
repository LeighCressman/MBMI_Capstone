...
This repository contains the methods and code for my capstone project in the Master of Biomedical Informatics (MBMI) program at the University of Pennsylvania. 

Included in this repository are: 
1) Prompt templates for urinary tract infection (UTI) symptoms
2) Code for calculating the cost to use large language models (LLMs) to process clinical notes
3) Code for preprocessing clinical notes, hitting model endpoints, evaluating model performance, and tracking experiments in Mlflow
4) Synthetic data for testing code
